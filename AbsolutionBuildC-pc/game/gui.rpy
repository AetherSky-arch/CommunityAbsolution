...
define gui.selected_color = '#e5e5e5'

## The color used for a text button when it cannot be selected.
define gui.insensitive_color = '#383838'
...
define gui.text_font = "col.otf"

## The font used for character names.
define gui.name_text_font = "gtw.otf"

## The font used for out-of-game text.
define gui.interface_text_font = "gtw.otf"
...
image bmshow:
    ...
    pause 1
    "gui/bmain/cafe.png" with Dissolve(2.0)
    pause 3
    "gui/bmain/door.png" with Dissolve(2.0)
    pause 3
    "gui/bmain/patients.png" with Dissolve(2.0)
    pause 3
    "gui/bmain/central.png" with Dissolve(2.0)
    pause 3
    "gui/bmain/offices.png" with Dissolve(2.0)
    pause 3
    "gui/bmain/mc.png" with Dissolve(2.0)
    pause 3
    "gui/bmain/hall.png" with Dissolve(2.0)
    pause 3
    "gui/bmain/doctor.png" with Dissolve(2.0)
    pause 3
    repeat
image mainmenu:
    "gui/f/black.png"
    "gui/main_menu.png" with Dissolve(2.0)
image gamemenu:
    "gui/f/black.png"
    pause 3
    "gui/f/fend.png" with dissolve
    "gui/f/black.png" with dissolve
    pause 3
    "gui/f/fhurt.png" with dissolve
    "gui/f/black.png" with dissolve
    pause 3
    "gui/f/ffind.png" with dissolve
    "gui/f/black.png" with dissolve
    pause 3
    "gui/f/fsave.png" with dissolve
    "gui/f/black.png" with dissolve
    pause 3
    "gui/f/fgive.png" with dissolve
    "gui/f/black.png" with dissolve
    pause 3
    "gui/f/fhuman.png" with dissolve
    "gui/f/black.png" with dissolve
    pause 3
    "gui/f/fhelp.png" with dissolve
    "gui/f/black.png" with dissolve
    pause 3
    "gui/f/fvisions.png" with dissolve
    "gui/f/black.png" with dissolve
    pause 3
    "gui/f/ftrust.png" with dissolve
    "gui/f/black.png" with dissolve
    pause 3
    "gui/f/fjust.png" with dissolve
    "gui/f/black.png" with dissolve
    pause 3
    "gui/f/fonly.png" with dissolve
    "gui/f/black.png" with dissolve
    pause 3
    "gui/f/fnight.png" with dissolve
    repeat

image difficulty:
    "gui/f/black.png" with dissolve
    pause 0.1
    "gui/difficulty.png" with Dissolve(2.0)
    pause 2.0
    "gui/difficulty2.png" with Dissolve(1.0)
    pause 1.3
    "gui/difficulty.png" with Dissolve(2.0)
    pause 2.0
    "gui/difficulty2.png" with Dissolve(1.0)
...
define gui.game_menu_background = "gamemenu"
